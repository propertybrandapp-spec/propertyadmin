...
const ROLE_STYLES = {
  ...
  admin: { bg: "#EFF6FF", color: "#1E88E5", label: "Admin" },
      ...
      <div className="max-w-3xl space-y-5">
        ...
        <div className="rounded-2xl p-6" style={{ background: "#EFF6FF", border: "1px solid #1E88E5" }}>
          ...
          <div className="flex items-start gap-2">
            ...
            <button onClick={copySql} className="text-xs font-bold px-3 py-2 rounded-lg shrink-0" style={{ background: "#1E88E5", color: "#FFFFFF" }}>
              {copied ? "Copied!" : "Copy"}
            </button>
          </div>
        </div>
